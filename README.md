...
20:10 — 「相合傘（あいあいがさ）」 — «Зонтик любви» («Поделиться зонтом»). Схематичное изображение зонта (в виде конуса с сердечком), разделённого пополам. Под каждой половиной написано имя влюблённого. Примерно так:
